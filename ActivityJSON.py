...
class ActivityJSON(object):
    ...
    def getCategory( self ):
        """ The 'general' type of an activity, disregarding the subtype.
    ...
    def getComment( self ):
        ...
        return self.json_dict['activityDescription']['value']
    ...
    def getStartTime( self ):
        ...
        # 'Thu, 2015 Oct 22 17:19'
        full_date = self.json_dict['beginTimestamp']['display']
